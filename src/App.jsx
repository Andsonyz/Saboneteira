...
function App() {
  ...
  const listaProdutos = [
    { id: 1, nome: "Protex", preco: 4.50, descricao: "Proteção antibacteriana", detalhes: "Elimina 99.9% das bactérias e cria uma barreira protetora." },
    { id: 2, nome: "Dove", preco: 5.20, descricao: "Hidratação profunda", detalhes: "Composto por 1/4 de creme hidratante para uma pele macia." },
    { id: 3, nome: "Lux", preco: 3.80, descricao: "Perfume irresistível", detalhes: "Fragrâncias florais inspiradas na perfumaria fina francesa." },
    { id: 4, nome: "Rexona", preco: 3.50, descricao: "Refrescância prolongada", detalhes: "Frescor que dura o dia todo com tecnologia de ponta." },
    { id: 5, nome: "Palmolive", preco: 3.90, descricao: "Nutrição natural", detalhes: "Fórmula com extratos de origem 100% natural para sua pele." }
  ]
